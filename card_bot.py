...
bot = TeleBot(token='5783974667:AAGQiuYhNQKG1y9-V4JAhE32MbynbpEXZH0', parse_mode='html') # создание бота
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        bot.send_message(
            ...
            text='Не понимаю тебя, попробуй ещё раз, я постараюсь понять тебя :( или напиши моему автору https://t.me/arr_kh',
        )
        return
